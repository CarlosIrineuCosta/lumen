...
class Photo(Base):
    ...
    # Image URLs - required for frontend display
    image_url = Column(String(500), nullable=False)  # Main image URL
    ...
    category = Column(String(50), default='portrait')  # portrait, artistic_nude, boudoir, lingerie, bikini, dark, fetish

    # Series/Collection association
    series_id = Column(UUID(as_uuid=True), ForeignKey("series.id", ondelete="SET NULL"))

    # Visibility and management
    is_deleted = Column(Boolean, default=False)  # Soft delete
    is_public = Column(Boolean, default=True)  # Public visibility
    ...
    series = relationship("Series", back_populates="photos", foreign_keys=[series_id])
