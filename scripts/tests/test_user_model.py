...
class TestUserModel:
    ...
    def test_user_model_creation(self, db_session, sample_user_data):
        ...
        user = User(
            id=sample_user_data["firebase_uid"],  # id is now the Firebase UID
        ...
        assert user.id == sample_user_data["firebase_uid"]
        assert user.firebase_uid == sample_user_data["firebase_uid"]  # Property for backward compatibility
    ...
    def test_user_default_values(self, db_session):
        ...
        user = User(
            id="test-uid-defaults",  # Use id instead of firebase_uid
