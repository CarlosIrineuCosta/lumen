...
class TestUserModel:
    ...
    def test_user_default_values(self, db_session):
        ...
        user = User(
            firebase_uid="test-uid-defaults",
    ...
    def test_user_type_properties(self):
        ...
        # Test photographer
        user = User(
            firebase_uid="test-photographer",
    ...
    def test_photographer_validation_requirements(self):
        ...
        user = User(
            firebase_uid="test-photographer-validation",
