...
# Load environment variables - explicitly look for .env in backend directory
import pathlib
...
# CORS middleware
allowed_origins = os.getenv("ALLOWED_ORIGINS", "http://localhost:3000,http://localhost:8000,http://localhost:19006,http://100.106.201.33:8000").split(",")
app.add_middleware(
    CORSMiddleware,
